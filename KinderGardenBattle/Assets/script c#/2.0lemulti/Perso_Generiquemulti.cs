...
public class Perso_Generiquemulti : MonoBehaviour
{
    public enum Classe
    {
        GUERRIER = 0,
    ...
    public PlayerMovemulti PlayerMove;
    ...
    public void SetClasse(Classe Klasse)
    {
        ...
        {
            PlayerMove = gameObject.GetComponent<PlayerMovemulti>();
    ...
    public double NewPV(int atk)
    {
        ...
        Animator anim = gameObject.GetComponent<TacticsMovemulti>().anim;
    ...
    public double GetCara(Perso_Generiquemulti persoGenerique, string demande) // demande en majuscule "HP" par exemple
    {
        switch (demande)
        {
            case "HP":
